...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-steam/node_modules/steam/node_modules/steam-resources/steam_language_parser/parser/token_analyzer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-steam/node_modules/steam/node_modules/steam-resources/steam_language_parser/parser/token_analyzer.js</span></h1>
    <h2>
        
        Statements: <span class="metric">95.65% <small>(110 / 115)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">85.71% <small>(42 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-steam/node_modules/steam/node_modules/steam-resources/steam_language_parser/parser/</a> &#187; token_analyzer.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2746</span>
<span class="cline-any cline-yes">2746</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">72</span>
<span class="cline-any cline-yes">72</span>
<span class="cline-any cline-yes">2674</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2746</span>
<span class="cline-any cline-yes">2603</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">3098</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3098</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">19570</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">19570</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">19570</span>
<span class="cline-any cline-yes">16361</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3209</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var language_parser = require('./language_parser');
...
exports.analyze = function(tokens) {
  ...
  while (tokens.length &gt; 0) {
    ...
    switch (cur.name) {
<span class="branch-0 cbranch-no" title="branch not covered" >      case 'EOF':</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
      case 'preprocess':
        var text = expect(tokens, 'string');
        
        <span class="missing-if-branch" title="else path not taken" >E</span>if (cur.value == 'import') {
          ...
          case 'class':
            {
              ...
              <span class="missing-if-branch" title="if path not taken" >I</span>if (expects) {
<span class="cstat-no" title="statement not covered" >                parent = expect(tokens, 'identifier');</span>
              }
...
function expect(tokens, name, value) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!peek) {
<span class="cstat-no" title="statement not covered" >    return language_parser.Token('EOF', '');</span>
  }
  
  <span class="missing-if-branch" title="if path not taken" >I</span>if (peek.name != name || value &amp;&amp; peek.value != value) {
<span class="cstat-no" title="statement not covered" >    throw new Error("Expecting " + name);</span>
  }
...
function optional(tokens, name, value) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!peek) {
<span class="cstat-no" title="statement not covered" >    return new language_parser.Token('EOF', '');</span>
  }
